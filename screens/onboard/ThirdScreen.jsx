...
const first = require("../../assets/img/imgbg3.jpg");
            ...
            <View>
                ...
                <View style={{ backgroundColor: COLORS.primary, height: '100%' }}>
                    <View style={{ width: '80%', alignSelf: 'center' }}>
                        <Text style={{ fontFamily: Fonts.black, fontSize: 28, textAlign: 'center', color: '#65B5FF' }}>Unlimited Live Stream
                        </Text>
                        <Text style={{ fontFamily: Fonts.black, fontSize: 28, textAlign: 'center', color: COLORS.white }}>of Events & Services</Text>
                    </View>
